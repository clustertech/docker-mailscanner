...
RUN curl -Lo /MailScanner-5.2.2-1.rhel.noarch.rpm https://github.com/MailScanner/v5/raw/master/builds/MailScanner-5.2.2-1.rhel.noarch.rpm; \
...
yum clean all; \
yum -y install /MailScanner-5.2.2-1.rhel.noarch.rpm /unrar-5.0.3-1.x86_64.rpm; \
